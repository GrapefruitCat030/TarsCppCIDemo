            ...
            switch(r.first - __Hello_all)
            {
                ...
                case 1:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, "", getModuleName(), "testHello", 0, _trace_param_, "");
                    }
    ...
    public:
        ...
        tars::Int32 testHello(const std::string & sReq,std::string &sRsp,const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CS), TRACE_ANNOTATION_CS, tars_moduleName(), tars_name(), "testHello", 0, _trace_param_, "");
            }
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, tars_moduleName(), tars_name(), "testHello", 0, _trace_param_, "");
            }
    ...
    public:
        ...
        static void async_response_testHello(tars::TarsCurrentPtr _current_, tars::Int32 _ret, const std::string &sRsp)
        {
            ...
            if (_current_->isTraced())
            {
                ...
                if(_current_->getServantHandle())
                {
                    TARS_TRACE(_current_->getTraceKey(), TRACE_ANNOTATION_SS, "", _current_->getModuleName(), "testHello", 0, _trace_param_, "");
                }
            }
            ...
            switch(r.first - __TestApp__Hello_all)
            {
                ...
                case 1:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SR), TRACE_ANNOTATION_SR, "", getModuleName(), "testHello", 0, _trace_param_, "");
                    }
                    ...
                    if(_current->isResponse())
                    {
                        ...
                        if (_pSptd_ && _pSptd_->_traceCall)
                        {
                            ...
                            TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SS), TRACE_ANNOTATION_SS, "", getModuleName(), "testHello", 0, _trace_param_, "");
                        }
